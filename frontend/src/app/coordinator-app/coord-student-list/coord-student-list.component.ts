...
@Component({
  selector: 'app-coord-student-list',
  templateUrl: './coord-student-list.component.html',
  styleUrls: ['./coord-student-list.component.scss']
})
export class CoordStudentListComponent implements OnInit {
    ngOnInit() {
